...
# -*- coding: utf-8 -*-
#
# pawls_ext documentation build configuration file
#
...
_version_py = os.path.join(repo, 'pawls_ext', '_version.py')
version_ns = {}
...
htmlhelp_basename = 'pawls_extdoc'
...
latex_documents = [
    (master_doc, 'pawls_ext.tex', 'pawls_ext Documentation',
     '', 'manual'),
]
